...
<section id="lh" class="footer">
  <div class="container">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <h3><strong>CÔNG TY CỔ PHẦN TÀU CAO TỐC PHÚ QUỐC (THANH CƯỜNG)</strong></h3>
            <br>  
            <ul>
			  <li><strong>Văn phòng đại diện TP.HN</strong></li>
			  <li><strong>Địa Chỉ:</strong> Phố Cao Đạt, Quận Hai Bà Trưng, Thành Phố Hà Nội</li>
			  <li><strong>Phone:</strong> 0365.629.897</li></ul>
        ...
        <div class="col-sm-3">
            ...
            <ul>
              <li style="color:white"><a href="mailto:alan45walker12@gmail.com"><p style="color:white">alan45walker12@gmail.com</p></a></li>
            <li>0365.629.897</li></ul>
...
<section class="copyright">
  <div class="container">
    <div class="row">
      <div class="col-sm-12 col-md-12 col-lg-12">
        <div class="copyrightInner"><strong>@ 2022 author: Tô Thanh Cường.</strong></div>
      </div>
    </div>
  </div>
</section>
